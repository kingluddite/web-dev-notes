...
* We should show or hide the navigation too as an option
    - Not the best option becuase it moves the navigation and makes it less user friendly
...
* But when you got to page `/slicemasters` that page is not being generated by gatsby-node.js that page is generated by simply bing in the `pages` folder in gatsby
