...
`$ git commit -m 'add video feature`
...
* Scroll down until you see the commits and you can click on the `add video feature`
...
* Locally your master branch doesn't have the new feature `video` added
* To prove this checkout of your `video` branch and check into your `master` branch
...
* You will see that all your changes by adding `videoe` are gone!
* View your app in the browser and it also shows now sign of your `video` feature!
...
* You now see that our `video` feature is back and working!
...
`Deleted branch video (was 14504fc).`
