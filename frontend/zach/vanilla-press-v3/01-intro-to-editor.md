...
Make sure to create the `js/editor.js` file.
...
#view .container .content .primary #pageContent article {
  margin: 10px 0 0;
  border-top: 1px #ededed solid;
  padding: 5px 0 10px;
}
#view .container .content .primary #pageContent article h3 {
  font-size: 1.2rem;
}
#view .container .content .primary #pageContent article p {
  font-size: 1rem;
}
...
#edit #deleteContent a {
  color: #999;
}
#edit #deleteContent a.hidden {
  display: none;
}
