...
<head>
  ...
  <title>grid-auto-flow dense Block Fitting!</title>
</head>
...
* Add random changes to every 6th cell
...
* We have empty spots in our grid
* When it gets to every 6th cell if it can't fit, it goes to the next line

## dense
* We can use `dense` to fill in missing spots
...
* dense fills in gaps
* Use it if order doesn't matter
* Like a css version of masonry
